...
$config = [
     ...
     * reverse proxy).
     */
    // SAML should always connect via 443, but some SSO providers will fail to
    // connect when the port number (443) is specified in the baseurlpath.
    // Remove :443 from this line as a troubleshooting step.
     ...
     * root directory.
     */
    'cachedir' => $_ENV['HOME'] . '/tmp/cache/simplesamlphp',
    'loggingdir' => NULL,
    'datadir' => 'data/',
    'tempdir' => $_ENV['HOME'] . '/tmp/simplesamlphp',
    ...
    'technicalcontact_email' => 'analytics@asu.edu',
    ...
    */
     ...
     */
    'secretsalt' => 'q03oe189s33pa12sdgfmh1b80imavlwf',
     ...
     */
    'auth.adminpassword' => 'c6Qq!hg3!UuRU7bAKK@b69%nT*M5Ls32',
     ...
     */
    'trusted.url.domains' => [
        'asufactory1.ddev.site',
        'asuanalytics.dev-asufactory1.acsitefactory.com',
        'asuanalytics-dev-asufactory1.acquia.asu.edu',
        'asuanalytics.test-asufactory1.acsitefactory.com',
        'asuanalytics-test-asufactory1.acquia.asu.edu',
        'asuanalytics.asufactory1.acsitefactory.com',
        'asuanalytics-asufactory1.acquia.asu.edu',
        'analytics.asu.edu',
    ],
