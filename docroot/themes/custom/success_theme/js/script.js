(function ($) {
    $(document).ready(function () {
      ...
      jQuery( document ).ready(function() {
        $(".colorbox-load").colorbox({iframe:true, width:"884", height:"540"});
      });
