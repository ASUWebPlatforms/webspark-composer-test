...
namespace Drupal\asu_format_advising\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'custom_date' widget.
 *
 * @FieldWidget(
 *   id = "custom_date",
 ...
 * )
 */
class CustomDateWidget extends DateTimeWidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['value'] = [
      ...
      '#date_year_range' => (date("Y") - 3) . ':' . (date("Y") + 3)
    ] + $element['value'];
  ...
  /**
   * Generates a range of years for the year dropdown.
   */
  protected function getYearRange($start_year, $end_year) {
    $years = range($start_year, $end_year);
    return array_combine($years, $years); // Key and value are the same.
  }
