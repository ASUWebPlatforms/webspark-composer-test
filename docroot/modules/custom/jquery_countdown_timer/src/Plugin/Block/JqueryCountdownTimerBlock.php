...
class JqueryCountdownTimerBlock extends BlockBase {
  ...
  public function defaultConfiguration() {
    ...
    $custom_id = $this->configuration['custom_id'];
    return ['countdown_datetime' => $countdown_datetime, 'font_size' => $font_size, 'custom_id' => $custom_id];
  }
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['custom_id'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Custom ID to differenciate timers. Use it when placing multiple countdown timers on a page.'),
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    ...
    $custom_id = $form_state->getValue('custom_id'); // Get value from the new form field.
    $block_id = isset($form['id']['#default_value']) ? $form['id']['#default_value'] : $custom_id;
