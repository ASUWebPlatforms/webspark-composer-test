...
/**
 * Provides a Visit replacement block - Scheduling your tour.
 *
 * @Block(
 *   id = "visit_replacement_block_schedulingyourtour",
 *   admin_label = @Translation("Scheduling your tour - Visit Replacement Block")
 * )
 */
class VisitReplacementBlockSchedulingyourtour extends BlockBase {
      ...
      <div class="uds-image-background-with-cta-container uds-content-align">
        <div class="container">
          ...
          <div id="wrapper-dropdowns" class="row"  style="background: rgba(0, 0, 0, 0.3);padding: 16px;">
              ...
              <button class="btn btn-gold" id="search" name="search">Search</button><!--<input name="uncertain" type="hidden" value="" />-->     
