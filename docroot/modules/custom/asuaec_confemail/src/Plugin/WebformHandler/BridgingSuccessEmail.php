 ...
 *
 * @WebformHandler(
 *   id = "Confirmation email for Bridging Success Early Start webform",
 *   label = @Translation("Confirmation email for Bridging Success Early Start webform"),
 *   category = @Translation("Form Handler"),
 *   description = @Translation("Confirmation email for Bridging Success Early Start webform"),
...
class BridgingSuccessEmail extends WebformHandlerBase {
...
<!--Main content-->		
	...
	<p>Thank you! You are now registered for ASU Bridging Success Early Start. We are excited to have you join our program!</p>

	<p>Please review the information below to make sure it is accurate and keep this for your records. If you have any changes, please email bridgingsuccess@asu.edu or call 602-496-0535.</p>

	<p><strong>Date Submitted:</strong> {$completed_dateTime}</p>
	<p>
	<strong>First name:</strong> {$values['first_name']}<br>
	<strong>Last name:</strong> {$values['last_name']}<br>
  <strong>ASU ID:</strong> {$values['asu_rite_id']}<br>
	<strong>Email:</strong> {$values['email']}<br>
  <strong>Phone:</strong> {$values['phone']}
	</p>

  <p><strong>Event Date:  Aug. 9 – August 14, 2026</strong></p>

	<p>
	<strong>Campus you will be attending:</strong> {$values['what_campus_will_you_be_attending_this_fall']}<br>
	<strong>Orientation date:</strong> {$values['your_asu_orientation_date']}<br />  
	<strong>Fall semester living on campus:</strong> {$values['do_you_plan_to_live_on_campus_in_the_fall']}
	</p>

	<p><strong>Agreements</strong></p>
	<ul>
	  <li>I agree to the Program Terms and Agreement</li>
	  <li>I agree to the terms of the Liability Waiver</li>
	  <li>I agree to the terms of the Photo and Video Release</li>
	  <li>I agree to the terms of the Health Emergency Care - Permission to  Transport/Treat</li>
	</ul>

	<fieldset style="padding:10px 15px;margin-bottom:20px;">
	<p><strong>Emergency Contact Information</strong></p>
	<p>
	<strong>Full name:</strong> {$values['full_name']}<br />
	<strong>Relationship to student:</strong> {$values['relationship_to_student']}<br />
	<strong>Phone:</strong> {$values['phone_number_emergency']}
	</p>
	</fieldset>
...
EOD;
		 ...
		 $key = 'confemail';
		 $to = $email;
		 $subject = "Bridging Success confirmation";
