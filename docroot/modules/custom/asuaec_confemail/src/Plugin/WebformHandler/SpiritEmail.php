 ...
 *
 * @WebformHandler(
 *   id = "Confirmation email for Spirit webform",
 *   label = @Translation("Confirmation email for Spirit webform"),
 *   category = @Translation("Form Handler"),
 *   description = @Translation("Confirmation email for Spirit webform"),
...
class SpiritEmail extends WebformHandlerBase {
...
//       	$sid = $webform_submission->id();
        ...
        $first_name = '';
        $main_content = '';
        $main_content_after_button = '';
      
//  $main_content = <<<EOD
        $main_content .= '<p>Thank you for registering for SPIRIT. This email confirms your spot in the 2026 SPIRIT program. We are looking forward to helping you adjust to campus life, build connections and identify mentors.</p>';
        $main_content .= '<p>To get a better idea of what SPIRIT is all about, we encourage you to <a href="https://www.youtube.com/watch?v=sIkJxJZNBNQ">watch this short video</a> that introduces the program and what you can expect.</p>';
        $main_content .= '<p>The SPIRIT program will run from Tuesday, Aug. 11 to Friday, Aug. 14. You must be admitted and enrolled or planning to enroll at ASU for fall 2026 to participate.</p>';

        $main_content .= '<p><strong>Below you will find details about:</strong>';
        $main_content .= '<ul>';
        $main_content .= '<li>What you&apos;ll be doing in the SPIRIT program</li>';
        $main_content .= '<li>How to get in touch with us</li>';
        $main_content .= '<li>How to buy books if you’re a Pell grant recipient.</li>';
        $main_content .= '</ul>';
        $main_content .= '</p>';
        $main_content .= '<h4>Program logistics and highlights</h4>';
        $main_content .= '<p>The core program activities are designed to take place over three full days.</p>';

        $main_content .= '<ul>';
        $main_content .= '<li>Prepare for your university experience</li>';
        $main_content .= '<li>Gain essential tools, skills and resources</li>';
        $main_content .= '<li>Build connections with peer ambassadors, staff, administrators, faculty and community mentors</li>';
        $main_content .= '<li>The program kicks off with a welcome ceremony on Tuesday, Aug. 11</li>';
        $main_content .= '<li>Core program activities will begin on Wednesday, Aug. 12 and end on Friday, Aug. 14.</li>';
        $main_content .= '<li><strong>Important:</strong> If you are living at a location that is different from the address you listed on My ASU, then please update your address on <a href="https://my.asu.edu">My ASU</a>.</li>';
        $main_content .= '</ul>';
        $main_content .= '<p>As it gets closer to August, you will receive an email from AISSS with more details such as the agenda and what to bring for your move-in day.</p>';
        $main_content .= '<p><strong>Set up Zoom appointments with our Student Success staff by clicking on an appointment link below or send an email to <a href="mailto:aisss@asu.edu">aisss@asu.edu</a></strong></p>';

        // BUTTON
        // $main_content .= '<p><a href="https://outlook.office365.com/owa/calendar/AmericanIndianStudentSupportServices@arizonastateu.onmicrosoft.com/bookings/">Schedule an appointment</a></p>';

        $main_content_after_button .= '<h4>Were you offered the Federal Pell Grant as part of your financial aid?</h4>';
        $main_content_after_button .= '<p>Pell Grant recipients are eligible to have up to $650 of their textbook charges billed to their student account, provided purchases are made at Sun Devil Campus Stores. To be eligible, students must submit all outstanding documents listed in the Finances tab on My ASU. An email from Financial Aid and Scholarship Services will be sent to eligible students.</p>';
        $main_content_after_button .= '<p>&nbsp;</p>';
        ...
        <img class="light-img" src="https://image.reply.asu.edu/lib/fe8d137272610d7c76/m/3/d9f2d016-e69b-4a9f-9054-b0651026a038.png" width="230" height="auto" alt="Arizona State University" style="border-collapse: collapse; text-align: left; font-size:22px; color:#ffc627; font-family: Arial, sans-serif; padding: 0px; line-height: 24px; font-weight: bold; width:230px !important;">
                ...
                <div class="dark-img" style="display:none; overflow:hidden; width:0px; max-height:0px; max-width:0px; line-height:0px; visibility:hidden;" align="left">
                    <img src="https://image.reply.asu.edu/lib/fe8d137272610d7c76/m/7/e0014106-a5a7-4286-9410-f5d5a1f52fc4.png" width="230" height="auto" alt="Arizona State University" style="border-collapse: collapse; text-align: left; font-size:22px; color:#ffc627; font-family: Arial, sans-serif; padding: 0px; line-height: 24px; font-weight: bold;">
                        ...
                        <tr>
                          <td id="asu_header" align="center" valign="top">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table class="darkmode4" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #ffffff; padding: 0px;">
  <tr>
    <td style="padding: 0px 0px 24px 0px;">
      <center>
        <table role="presentation" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="buttonHover" align="center" style="-webkit-border-radius: 48px; -moz-border-radius: 48px; border-radius: 48px;" bgcolor="#ffc627">

              <!--[if mso]><span align="center" style="width:300px;"><![endif]-->
              <a alias="Schedule an appointment" href="https://outlook.office365.com/owa/calendar/AmericanIndianStudentSupportServices@arizonastateu.onmicrosoft.com/bookings/" nowrap="nowrap" target="_blank" style="font-weight: bold; font-size: 16px; font-family: Arial, sans-serif; color: #000000; text-decoration: none; -webkit-border-radius: 48px; -moz-border-radius: 48px; border-radius: 48px; width: 250px; padding: 12px; border: 1px solid #ffc627; display: inline-block;">

                <!--[if gte mso 9]><span style="color: #ffc627;">&nbsp;</span><![endif]-->
Schedule an appointment
                <!--[if gte mso 9]><span style="color: #000000;">&nbsp;&rarr;&nbsp;</span><![endif]-->
              </a>
              ...
              <!--[if mso]></span><![endif]-->
                        ...
                        <!-- END OF main_content_after_button -->
