 ...
 *
 * @WebformHandler(
 *   id = "Confirmation email for SKO webform",
 *   label = @Translation("Confirmation email for SKO webform"),
 *   category = @Translation("Form Handler"),
 *   description = @Translation("Confirmation email for SKO webform"),
...
class SkoEmail extends WebformHandlerBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission) {
    ...
    $main_content .= "<p>Thank you for registering for the Indigenous Sun Devil Experience.</p>";
    $main_content .= "<p>We are excited to welcome you and your family to Arizona State University. This should be a special weekend as our SKO to ASU event is the same weekend as the 37th annual <a href='https://asu365communityunion.com/powwow'>Pow Wow</a> at ASU.</p>";
    $main_content .= "<p><strong>Info about SKO to ASU:</strong>";
    $main_content .= "<p>Saturday, April 18, 2026<br />8 a.m. to 1:30 p.m.<br />Memorial Union, ASU's Tempe campus</p>";
    $main_content .= "<p><strong>Arrival:</strong> Please arrive by 7:30 a.m. so you can get checked in as we will begin promptly at 8 a.m.</p>";
    ...
    $main_content .= "<p>If you have any questions about this event or or need accommodations, please contact Natalynne Rogers at <href a='mailto:asunatalynnerogers@asu.edu'>asunatalynnerogers@asu.edu</a>.</p>";
    $main_content .= "<p>Sincerely,</p>";
    $main_content .= "<p>Askwali, Ahéhee’, Nya:weh, Mvto (Thank you),</p><p>Natalynne Rogers (Hopi)<br />Associate Director</p>";
    $main_content .= "<p>&nbsp;</p>";      
...
EOD;
		 ...
		 $key = 'confemail';
		 $to = $email;
		 $subject = "You're registered for SKO";
