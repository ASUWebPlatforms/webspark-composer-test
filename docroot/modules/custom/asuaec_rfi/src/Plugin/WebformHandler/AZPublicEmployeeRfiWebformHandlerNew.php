 ...
 *
 * @WebformHandler(
 *   id = "rfi_webform_handler_azpublicemployee_new",
 *   label = @Translation("Post to middleware - AZ Public Employee Scholarship NEW"),
 *   category = @Translation("Form Handler"),
 *   description = @Translation("Send the submission to Middleware - AZ Public Employee Scholarship NEW"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_UNLIMITED,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_REQUIRED,
 * )
 **/
class AZPublicEmployeeRfiWebformHandlerNew extends WebformHandlerBase {
  ...
  public function postToMiddleware($webform_submission) {
      ...
      $municipality = $values['municipality'] ?? ''; // tempe, pima, other or adoa
      ...
      switch($municipality) {
        case 'adoa' :
          $sub_class = 'AZPES';
          $municipality_name = "Arizona Department of Administration (ADOA)";
          break;

        case 'tempe' :
          $sub_class = 'COT';
          $municipality_name = "City of Tempe";
          break;

        case 'pima' :
          $sub_class = 'PCO';
          $municipality_name = "Pima County";
          break;

        case 'other' :
          // Get Subclass from Config
          $sub_class = $config2->get('online_subclass_prod'); // $sub_class - 'PES'
          break;
      }
