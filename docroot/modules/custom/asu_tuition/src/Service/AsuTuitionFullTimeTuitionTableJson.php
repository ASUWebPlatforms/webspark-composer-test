 ...
 */
class AsuTuitionFullTimeTuitionTableJson {

  /**
   *
   */
  public function getFullTimeTuitionTableJson($result) {
    // ksm($result);
    $table = [
      'header' => [
          ['data' => t('Tuition/Fee Description'), 'class' => ['fee-description'], 'data-class' => 'expand'],
          ['data' => t('Fall ' . substr($result->acad_year->descr, 0, 4)), 'class' => ['fee-amount', 'text-right', 'mobile-hide'], 'data-hide' => 'phone,tablet'],
          ['data' => t('Spring ' . substr($result->acad_year->descr, 5, 4)), 'class' => ['fee-amount', 'text-right', 'mobile-hide'], 'data-hide' => 'phone,tablet'],
