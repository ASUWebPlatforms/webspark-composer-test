...
const InfoPassion = ({localWebUrl}) => {
    ...
    return (
        <div className='infoPassion bookArea col-12'>
             <div className="headerImage" dangerouslySetInnerHTML={{ __html: data.what_to_do_with_life || '' }}></div>

            <div className="animated-bg-new" data-aos="slide-in" data-aos-once="false" data-aos-offset="200">
            ...
            <div className="headerVideo col-12" dangerouslySetInnerHTML={{ __html: data.asu_tour_video || '' }} />
