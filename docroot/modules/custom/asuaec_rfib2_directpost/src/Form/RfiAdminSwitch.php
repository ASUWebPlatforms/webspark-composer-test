...
/**
 * @file
 * Conttains Drupal\asuaec_rfib2_directpost\Form\RfiAdminSwitch
 */

namespace Drupal\asuaec_rfib2_directpost\Form;
...
class RfiAdminSwitch extends ConfigFormBase{
   ...
   * @var string
   */
  const SETTINGS = 'asuaec_rfib2_directpost.customadmin_settings'; // Config variable name for module.

  /**
   *{ @inheritdoc}
   */
  public function getFormID(){
    return 'asuaec_rfib2_directpost_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('asuaec_rfib2_directpost.customadmin_settings');
...
//      $this->config('asuaec_rfib2_directpost.customadmin_settings')
//         ->set($key, $each_value)
//         ->save();
//    }
