...
// this is how to get the node info
 ...
 //       ->load("paragraph" . '.' . "service_paragraphs" . '.' . "default");
        ...
        foreach ($nodes as $node) {
            ...
            $s["contingent"] = false;
            $contingent = $node->get('field_contingent')->getValue();
            $contingentArray = (array)$contingent[0];
            if ($contingentArray['value'] == "1"){
                $s["contingent"] = true;
            }
    ...
    public function configuration() {
        ...
        $data["service_detail"] = $config->get("service_detail");
        ...
        $data["footer_disclaimers"] = $config->get("footer_disclaimers");
        $data["asu_responsibilities"] = $config->get("asu_responsibilities");
