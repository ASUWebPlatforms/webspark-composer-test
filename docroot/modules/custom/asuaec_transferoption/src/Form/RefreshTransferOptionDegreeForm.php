<?php
namespace Drupal\asuaec_transferoption\Form;
 ...
 */
class RefreshTransferOptionDegreeForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#type' => 'item',
      '#markup' => $this->t('Refresh the asu transferoption table in the database'),
    ];
    ...
    $form['actions']['transferoption_refresh'] = [
        '#type' => 'submit',
        '#value' => $this->t('Populate/refresh Transfer Option related degree tables'),
        '#submit' => ['::transferoptionFormSubmit'],
    ];
  ...
  public function getFormId() {
    return 'asuaec_transferoption_refresh_degree_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
     ...
     */
    public function transferoptionFormSubmit(array &$form, FormStateInterface $form_state) {
    ...
    public function generateBatch1() {
        ...
        //foreach($all_categories as $cat_id => $cat_name) {
            ...
            $operations[] = [
                'asuaec_transferoption_data_insert',
                [],
            ];
        ...
        $batch = [
            'title' => $this->t('Getting Transfer Option degrees.', []),
            'operations' => $operations,
            'finished' => 'asuaec_transferoption_finished',
        ];
        return $batch;
    }
