...
class UpdateContentTypePublishStatus
{
  /**
   * Publish or unpublish all nodes of a given content type.
   *
   ...
   * @return void
   */
  public static function batchInit(string $contentType, string $action, int $batchSize = 50): void
  {
  ...
  {
    if ($success) {
      Drupal::logger('analytics_operations')->notice('Update Content Type Publish Status operation.');
