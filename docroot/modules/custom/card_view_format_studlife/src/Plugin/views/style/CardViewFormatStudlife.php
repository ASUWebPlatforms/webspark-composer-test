<?php
namespace Drupal\card_view_format_studlife\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "card_view_format_studlife",
 *   title = @Translation("Student Life Cards Style"),
 *   help = @Translation("Displays content in four-column image cards."),
 *   theme = "views_view_card_view_format_studlife",
 *   display_types = {"normal"}
 * )
 */
class CardViewFormatStudlife extends StylePluginBase {
