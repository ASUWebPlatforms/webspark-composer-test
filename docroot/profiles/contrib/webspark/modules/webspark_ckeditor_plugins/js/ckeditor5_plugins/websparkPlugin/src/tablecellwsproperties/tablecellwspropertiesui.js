...
export default class TableCellWsPropertiesUI extends Plugin {
   ...
   *
   * @return TableCellWsPropertiesView cell properties form view instance.
   */
  _createPropertiesView() {
    ...
    this.listenTo(view, "submit", () => {
      this.editor.execute("tableCellWsClass", {
        cellType: view.classselect,
        width: view.classwidthselect,
        alignHorizontal: view.classalignhorizontalselect,
        alignVertical: view.classalignverticalselect,
      });
      this._hideView();
    });
  ...
  _showView() {
    ...
    if (cell && cell.parent) {
      ...
      this.view.classwidthselect = cell.getAttribute("width") || "";
      this.view.classalignhorizontalselect =
        cell.getAttribute("alignHorizontal") || "";
      this.view.classalignverticalselect =
        cell.getAttribute("alignVertical") || "";
    }
