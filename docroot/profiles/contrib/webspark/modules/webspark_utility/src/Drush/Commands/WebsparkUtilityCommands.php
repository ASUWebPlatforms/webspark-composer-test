...
final class WebsparkUtilityCommands extends DrushCommands {
  ...
  public function refreshConfigs() {
    ...
    $websparkPaths = (array) (glob('profiles/contrib/webspark/modules/webspark/*/config/install', GLOB_ONLYDIR)) ? glob('profiles/contrib/webspark/modules/webspark/*/config/install', GLOB_ONLYDIR) : [];
    // Add webspark profile configs to the array.
    $websparkPaths[] = 'profiles/contrib/webspark/config/install';
      ...
      switch (TRUE) {
        ...
        case preg_match('/^Removing.*$/m', $output):
          ...
          foreach (glob($dir) as $filename) {
            ...
            $filesToSkip = [
              'profiles/contrib/webspark/config/install/block.block.asubrandheader.yml',
              'profiles/contrib/webspark/config/install/block.block.asufooter.yml',
              'profiles/contrib/webspark/config/install/system.site.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/field.field.paragraph.card.field_card_link.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/field.field.paragraph.card.field_clickable.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/field.field.paragraph.card_with_icon.field_card_link.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/field.field.paragraph.card_with_icon.field_clickable.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/filter.format.basic_html.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/filter.format.full_html.yml',
              'profiles/contrib/webspark/modules/webspark/webspark_blocks/config/install/filter.format.restricted_html.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card.field_card_link.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card.field_clickable.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_degree.field_card_link.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_degree.field_clickable.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_story.field_card_link.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_story.field_clickable.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_with_icon.field_card_link.yml',
              'profiles/contrib/webspark/config/install/field.field.paragraph.card_with_icon.field_clickable.yml',
              'profiles/contrib/webspark/config/install/field.storage.paragraph.field_card_link.yml',
              'profiles/contrib/webspark/config/install/field.storage.paragraph.field_clickable.yml',
            ];
