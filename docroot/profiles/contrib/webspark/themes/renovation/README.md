...
IMPORTANT NOTE: theme assets build using NPM in the CI pipeline. The below documentation
does not reflect the new recommendation that you should now use NPM when compiling assets locally
and should include package-lock.json files when committing package.json updates here.
