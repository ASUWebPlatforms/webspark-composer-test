 ...
 * @endcode
 */
$settings['hash_salt'] = 'PLb9T_3hqIj9h1bOEpxzwehpQHCYIh1J_4zCWiJlMUc1GhJ6whTT41gnoVJfYZGD_li-GVDplA';
 ...
 *
 * The filesystem path that the nobackup:// stream wrapper will point to.
 */
$_site_group = $_ENV['AH_SITE_GROUP'] ?? '';
$_site_env = $_ENV['AH_SITE_ENVIRONMENT'] ?? '';
$_site_db_name = $GLOBALS['gardens_site_settings']['conf']['acsf_db_name'] ?? '';
if ($_site_group !== '' && $_site_env !== '' && $_site_db_name !== '') {
  $settings['file_nobackup_path'] = "/mnt/gfs/{$_site_group}.{$_site_env}/nobackup/{$_site_db_name}";
}
